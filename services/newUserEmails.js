...
const welcomeNewUserTemplate = async (user) => {
    ...
    return {
        subject: 'Welcome to Cola\'s Club!',
        html: `
            <!DOCTYPE html>
            <html lang="en">
            <head>
                ...
                <title>Welcome to Cola\'s Club</title>
            </head>
            ...
            <div style="background:#fff;margin:0 auto;padding:20px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.05);max-width:600px;">
                <div style="text-align:center;margin-bottom:20px;">
                    <img src='https://colasclub.fun/static/images/Cola's Club Official Logo.png' alt='Cola\'s Club Logo' style='max-width:200px;width:100%;auto;display:block;margin:0 auto;'>
                </div>
                <h1 style="color:#2c3e50;margin:0 0 20px 0;font-size:28px;">Hi ${user.firstName}, welcome to Cola\'s Club!</h1>
                ...
                <div style="background-color:#f8f9fa;padding:18px 20px;border-radius:8px;margin:30px 0 20px 0;border-left:4px solid #0e747c;">
                    ...
                    <div style="margin:10px 0 0 0;">
                        <a href="https://colasclub.fun/events" style="background-color:#0e747c;color:white;padding:10px 22px;text-decoration:none;border-radius:5px;display:inline-block;font-weight:bold;font-size:15px;margin-right:10px;">See All Events</a>
                        <a href="https://colasclub.fun/contact" style="background-color:#27ae60;color:white;padding:10px 22px;text-decoration:none;border-radius:5px;display:inline-block;font-weight:bold;font-size:15px;">Contact Us</a>
                    </div>
                </div>
                <div style="text-align:center;margin:30px 0 0 0;">
                    <a href="#" style="margin:0 10px;display:inline-block;"><img src="https://cdn-icons-png.flaticon.com/24/733/733547.png" alt="Facebook" style="vertical-align:middle;"></a>
                    <a href="#" style="margin:0 10px;display:inline-block;"><img src="https://cdn-icons-png.flaticon.com/24/2111/2111463.png" alt="Instagram" style="vertical-align:middle;"></a>
                    <a href="#" style="margin:0 10px;display:inline-block;"><img src="https://cdn-icons-png.flaticon.com/24/2111/2111463.png" alt="Reddit" style="vertical-align:middle;"></a>
                    <a href="mailto:admin@colasclub.com" style="margin:0 10px;display:inline-block;"><img src="https://cdn-icons-png.flaticon.com/24/732/732200.png" alt="Email" style="vertical-align:middle;"></a>
                </div>
